    ...
    (r.prototype.validateInput = function (e) {
      ...
      if (
        ...
        this.$element.trigger(
          (e = t.Event("validate.bs.validator", { relatedTarget: a[0] }))
        ),
        ...
        this.runValidators(a).done(function (o) {
          a.data("bs.validator.errors", o),
            ...
            i.toggleSubmit(),
            i.$element.trigger(
              t.Event("validated.bs.validator", { relatedTarget: a[0] })
            );
        });
      }
    }),
    ...
    (r.prototype.toggleSubmit = function () {
      this.options.disable &&
        t('button[type="submit"], input[type="submit"]')
          ...
          .toggleClass("disabled", this.isIncomplete() || this.hasErrors())
